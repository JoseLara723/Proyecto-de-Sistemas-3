				...
				<ul>
					...
					<li>
						<a href="#" data-toggle="modal" data-target="#myModal2">
							<span class="fa fa-pencil-square-o" aria-hidden="true"></span> Clientes VIP </a>
					</li>
				</ul>
				<!-- //header lists -->
				<!-- search -->
...
-->				<div class="table-responsive " id="div1">
					...
					<table class="timetable_sub">
						...
						<tbody>
							<?php foreach($_SESSION['detalle'] as $det){  $it+=1;
							$sbtotal = $det['cant']*$det['precio'];
							$totall += $sbtotal;
							?> 

							<tr class="rem1">
								<td class="invert"><?php echo $it; ?></td>
...
<script src="login/js/myjavaMobil.js"></script>
			...
			<div class="checkout-left">
				<div class="address_form_agile">
					<h4>Completar Datos para Envio</h4>
				<form id="formulario1" class="creditly-card-form agileinfo_form" onsubmit="return agregaRegisss();">
						<input type="hidden" name="pro" value="Registro" >

						<div class="creditly-wrapper wthree, w3_agileits_wrapper">
							<div class="information-wrapper">
								<div class="first-row">
									<div class="controls">
										<input class="billing-address-name" type="text" name="nomm" placeholder="Nombre Completo" required="">
									</div>
									<div class="w3_agileits_card_number_grids">
										<div class="w3_agileits_card_number_grid_left">
											<div class="controls">
												<input type="text" placeholder="Numero de Celular" name="ncel" required="">
											</div>
										</div>
										<div class="w3_agileits_card_number_grid_right">
											<div class="controls">
												<input type="text" placeholder="Direccion" name="dire" required="">
											</div>
										</div>
										<div class="clear"> </div>
									</div>
									<div class="controls">
										<input type="text" placeholder="Referencia Direccion" name="refe" required="">
									</div>
									<div class="controls">
										<select class="option-w3ls" id="tipp" name="tipp">
								...
								<button class="submit check_out RegisPedido" id="reg">Confirmar Pedido</button>
								
								<a href="javascript:CancelarPedido();" class="btn btn-info" id="botti4" role="button">Cancelar Pedido</a>
							</div>
						</div>
					</form>
					...
					<div class="checkout-right-basket">
						...
						<!--<a href="javascript:reportePDFdelivery();">Imprimir Pedido
							<span class="fa fa-hand-o-right" aria-hidden="true"></span>
						</a>-->

						<!--<a href="#">Cancelar Pedido
