...
require_once '../Model/Producto6.php';
		...
		if (count($_SESSION['detalle'])>0) {
			...
			//	$idventa = $result_ultima_venta->ultimo;
				...
				foreach($_SESSION['detalle'] as $datos):
					...
					$objProducto->GuardarEsquina($idservicio, $descripcion, $cantidad, $precio, $subtotal,$nnota,$codigo,$foto,$codg,$grupo);
					$objProducto->ActualizarEsquina($idservicio, $cantidad);

				endforeach;
				$objProducto->Actualizarcodnu($nnota);

	$objProducto->guardarTotEsquina($observ,$ttotal,$nnota,$idusu,$grupo);
