...
<tr><td width="150" ><?php echo $f['detmenu']; ?></td></tr>
<tr><td width="150"><?php	echo '<img src="'.$f['fotome'].'" width="400" heigth="400"/>';?></td></tr>
<?php } ?>
</table>

<form action="sho_subirFotoavisou.php" method="post" id="formulario" enctype="multipart/form-data">
