...
<link rel="stylesheet" href="../bootstrap/css/bootstrap.min.css">
	...
	<script src="../js/myjavaCajera.js"></script>
...
body {
    ...
    background-image: url(../recursos/fondo_adm3.jpg);
}
.col-md-8.medio {
	text-align: center;
  ...
  <div class="container-fluid">
   ...
   <!--     <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="sho_menu.php">PREPARACIONES</a></li>
            <li><a href="sho_grupos.php">GRUPOS</a></li>
            <li><a href="sho_motoqueros.php">REPARTIDORES</a></li>
          </ul>
        </li>-->
          ...
          <ul class="dropdown-menu">
            <!--<li><a href="sho_aprobar.php">PEDIDOS</a></li>-->
			  <li><a href="sho_cajaUu.php">DEPOSITOS A CAJA</a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="sho_Ventasdiau2.php">GANANCIAS</a></li>
          </ul>
        </li>
