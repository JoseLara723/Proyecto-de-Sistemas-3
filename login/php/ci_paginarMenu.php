...
//$coddepx= $_SESSION['depto'];
    ...
    $nroProductos = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM menuu AS me LEFT JOIN grupos AS g ON me.codgru=g.codgru"));
    $nroLotes = 10;
    ...
    if($paginaActual < $nroPaginas){
  	...
  	$registro = mysqli_query($conexion,"SELECT * FROM menuu AS me LEFT JOIN grupos AS g ON me.codgru=g.codgru LIMIT $limit, $nroLotes ");
...
<td><a href="javascript:editarProp1('.$registro2['codme'].');" >'.$registro2['detmenu'].'</a></td>									<td>'.$registro2['detgrupo'].'</td>
							...
							<td align="center"><a href="javascript:mostrarfoto('.$registro2['codme'].');" ><img src="'.$registro2['fotome'].'" width="30" height="30"> </a> </td>
