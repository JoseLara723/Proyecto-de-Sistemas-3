...
<script src="../js/myjavaCin2.js"></script>
...
<center><h4>FORMULARIO DE VIDEOS</h4></center>
</div> <!-- fin col-sm-2 -->
<div class="col-sm-4 hidden-xs" style="background-color:white;">
    ...
    <div class="modal fade" id="registra-artis" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistroDat2();">
            <div class="modal-body">
					 <input type="hidden"   id="idar" name="idar" />
                   	<input type="hidden" required readonly id="pro" name="pro"/>

                <div class="form-group">
                <label class="control-label col-xs-3 titi" for="descla">Detalle :</label>
                <div class="col-xs-9">
                <input type="text" class="form-control" id="descla" name="descla" required placeholder="Detalle">
                </div>
                </div>


                <div class="form-group">
                <label  class="control-label col-xs-3 titi" for="urldat">Direccion URL:</label>
                <div class="col-xs-9">
                <textarea class="form-control" rows="3" id="urldat" required name="urldat" placeholder="Direccion URL"></textarea>
                </div>
                </div>                
