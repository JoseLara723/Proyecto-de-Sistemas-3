...
//	include('conexion.php');
    ...
    $nroProductos = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM personal WHERE codsuc='$codsucx'"));
    $nroLotes = 10;
    ...
    if($paginaActual < $nroPaginas){
  	...
  	$registro = mysqli_query($conexion,"SELECT * FROM personal WHERE codsuc='$codsucx' LIMIT $limit, $nroLotes ");
