...
<tr><td width="150"><?php	echo '<img src="'.$f['fotoprop3'].'" width="400" heigth="400"/>';?></td></tr>
<?php } ?>
</table>

<form action="ci_subirFotoaviso3.php" method="post" id="formulario" enctype="multipart/form-data">
