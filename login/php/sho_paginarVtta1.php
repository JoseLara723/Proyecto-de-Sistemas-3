...
//   	}
 	...
 	$registro = mysqli_query($conexion,"SELECT * FROM movimtot AS mt LEFT JOIN usuarios AS us ON mt.id_usu=us.id_usu  WHERE  mt.fechato='$fecha' AND estado='Cancelado'  ");
...
$tct=0;
  ...
  $fech= date("d-m-Y", strtotime($registro2['fechato']) );
    ...
    $reg = mysqli_query($conexion,"SELECT * FROM fgasto AS fg LEFT JOIN usuarios AS u ON fg.id_usu=u.id_usu WHERE  fg.fechaga='$fecha'  ");    
    $ttt1=0;
