...
//switch($proceso){
//	case 'Registro':
		mysqli_query($conexion,"INSERT INTO solicitud (fechasol,nombresol,emailsol,celusol,codpropi,observsol,cancelo,codigosol,taviso)VALUES
		 ('$fecha','$nom','$emma','$cel','$codx','$observ','NO','$codigo','CAM')");
		 
		 mysqli_query($conexion,"UPDATE cambalache SET nconsul =nconsul+1 WHERE codcam = '$codx'");
//	break;
