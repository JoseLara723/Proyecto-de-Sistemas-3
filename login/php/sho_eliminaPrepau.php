...
$registro = mysqli_query($conexion,"SELECT * FROM menuu AS me LEFT JOIN grupos AS g ON me.codgru=g.codgru LEFT JOIN sucursal AS su ON me.codsuc=su.codsuc  WHERE me.codsuc='$codsucx'");
