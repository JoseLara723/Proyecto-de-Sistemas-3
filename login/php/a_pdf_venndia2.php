...
$registro = mysqli_query($conexion,"SELECT * FROM movimtot AS mt LEFT JOIN usuarios AS us ON mt.id_usu=us.id_usu  WHERE mt.fechato BETWEEN '$desde' AND '$hasta' AND mt.id_usu='$idusu'  ");
...
$html .= '<td align="center" class="profo">VENTAS DEL DIA</td><td align="right">TITI DELIVERY<br>La Paz -Bolivia</td></tr>';
$html .= '</table>';
...
$reg = mysqli_query($conexion,"SELECT * FROM fgasto AS fg LEFT JOIN usuarios AS us ON fg.id_usu=us.id_usu  WHERE  fg.fechaga BETWEEN '$desde' AND '$hasta' AND fg.id_usu='$idusu'  ");
