...
<script src="../js/myjavaSucu.js"></script>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="dsucu">Sucursal :</label>
                    <div class="col-xs-5">
        			<input type="text" class="form-control" id="dsucu" name="dsucu" required placeholder="Grupo ">
                    </div>
    			</div>
