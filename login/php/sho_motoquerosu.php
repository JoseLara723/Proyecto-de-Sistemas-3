...
<script src="../js/myjavaMotou.js"></script>
...
<center><h3>REPARTIDORES</h3></center>
</div> <!-- fin col-sm-2 -->
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>DATOS</b></h4>
            </div>
            <form id="formulario" class="form-horizontal " onsubmit="return agregaRegistroRe();">
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="pla">Placa :</label>
                    <div class="col-xs-5">
        			<input type="text" class="form-control" id="pla" name="pla" required placeholder="Placa ">
                    </div>
    			</div>
