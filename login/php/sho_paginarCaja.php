...
//		$fe2= date("d-m-Y", strtotime($registro2['fechavence']) );
		...
		$tabla = $tabla.'<tr>
							...
							<td align="center">  <a href="javascript:VerPedido('.$registro2['norden'].');" ><img src="../recursos/buscar1.png" data-toggle="tooltip" title="Ver Pedido"></a> <a href="javascript:ImprimirPdf('.$registro2['norden'].');" ><img src="../recursos/impresora2.png" data-toggle="tooltip" title="Imprimir Nota"></a>';
							if($estax=='Enviado'){
