...
date_default_timezone_set('America/La_Paz');
    ...
    $nroProductos = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM fgasto WHERE fechaga='$fecha'  "));
    $nroLotes = 10;
    ...
    if($paginaActual < $nroPaginas){
  	...
  	$registro = mysqli_query($conexion,"SELECT * FROM fgasto WHERE fechaga='$fecha' AND id_usu='$idusu' LIMIT $limit, $nroLotes ");
