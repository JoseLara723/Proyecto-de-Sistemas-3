...
//		$fe2= date("d-m-Y", strtotime($registro2['fechavence']) );
		...
		$tabla = $tabla.'<tr>
							...
							if($estax=='Pendiente'){
								$tabla = $tabla.'<a href="javascript:Asignar('.$registro2['norden'].');" ><img src="../recursos/moto1.png" data-toggle="tooltip" title="Asignar Entrega"></a>';
							}
							
							 $tabla = $tabla.'<a href="javascript:eliminarProp1('.$registro2['norden'].');" ><img src="../recursos/borrar.png" data-toggle="tooltip" title="Eliminar Pedido"></a></td>
						  </tr>';		
	}
