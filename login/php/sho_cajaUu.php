...
$persomoto = $objProducto->getPersonalmoto2();
...
<script src="../js/myjavaCajau2.js"></script>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="sho_cajera.php">Menu</a>
    </div>
        ...
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<div class="form-group">
				<label  class="control-label col-xs-3 titi" for="ingre">Detalle:</label>
				<div class="col-xs-7">
    ...
    <div class="modal fade" id="registra-asigna" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
              <h4 class="modal-title" id="myModalLabel"><b>Formulario de Pago</b></h4>
            </div>
            

			  
            <form id="formulario3" class="form-horizontal " onsubmit="return agregaPago();">
            <div class="modal-body">
            ...
            <div class="modal-footer">
                ...
                <input type="submit" value="Registrar Pago" class="btn btn-warning"  id="edi3"/>
                <button type="button" class="btn btn-default" data-dismiss="modal">Salir</button>
            </div>
            </form>
