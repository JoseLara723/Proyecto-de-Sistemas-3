...
$html .= '<td align="center" class="profo">REPORTE DE CAMBALACHE</td><td align="right"  width="40%">Inmuebles</td></tr>';
$html .= '</table>';
...
$it=0;
$row = mysqli_query($conexion,"SELECT * FROM cambalache AS ca LEFT JOIN propietariocam AS pr ON ca.coddue=pr.coddue ");
...
$html .='<tr>
							...
							<td align="right">'.$registro2['precioca'].'</td>
