...
$codsucx=$_SESSION['codsuc'];
    ...
    $nroProductos = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM usuarios AS u LEFT JOIN sucursal AS su ON u.codsuc=su.codsuc WHERE u.codsuc='$codsucx' AND u.id_area!='admin' "));
    $nroLotes = 10;
    ...
    if($paginaActual < $nroPaginas){
  	...
  	$registro = mysqli_query($conexion,"SELECT * FROM usuarios AS u LEFT JOIN sucursal AS su ON u.codsuc=su.codsuc WHERE u.codsuc='$codsucx' AND u.id_area!='admin'  LIMIT $limit, $nroLotes ");
