...
$persomoto = $objProducto->getPersonalmotosuc($codsucx);
...
<script src="../js/myjavaAprobaru.js"></script>
...
-->      </ul>
    <form class="navbar-form navbar-left">
      ...
      <div class="input-group">
        <input type="text" class="form-control" id="bs-prod" placeholder="Cliente">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="prepa">Productos :</label>
                    <div class="col-xs-7">
				...
				<div class = "form-group">
      			<label for = "iidper" class="control-label col-xs-3 titi">Categorias :</label>
                <div class="col-xs-5" >
				...
				<div class="form-group">
				<label  class="control-label col-xs-3 titi" for="ingre">Detalles:</label>
				<div class="col-xs-7">
...
<!--- fin modal -->    
    ...
    <!-- MODAL PARA EL REGISTRO DE PRODUCTOS-->
    <div class="modal fade" id="registra-asigna" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
              <h4 class="modal-title" id="myModalLabel"><b>Datos de Asignacion</b></h4>
            </div>
            

			  
            <form id="formulario3" class="form-horizontal " onsubmit="return agregaAsigna();">
            <div class="modal-body">
					 <input type="hidden"   id="idx3" name="idx3" />
			    ...
			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="clie3">Cliente :</label>
                    <div class="col-xs-7">
        			<input type="text" class="form-control" id="clie3" name="clie3" required placeholder="Cliente ">
                    </div>
    			</div>

			    <div class="form-group">
        			<label class="control-label col-xs-3 titi" for="pre3">Importe Total:</label>
                    <div class="col-xs-3">
        			<input type="text" class="form-control" id="pre3" name="pre3" required placeholder="Total">
                    </div>
    			</div>
                ...
                <div class="col-xs-5" >
					<select name="cperm3" id="cperm3" class="form-control" >
                    <option value="0">Ninguno</option>
						<?php foreach($persomoto as $p1):?>
						<option value="<?php echo $p1['coden']?>"><?php echo $p1['nombreper']?></option>
						<?php endforeach;?>
					</select>
				...
				<div class="form-group">
				<label  class="control-label col-xs-3 titi" for="obv3">Observacion:</label>
				<div class="col-xs-7">
				<textarea class="form-control" rows="5" id="obv3" required name="obv3" placeholder="Observaciones"></textarea>
				</div>
				</div>                
            ...
            <div class="modal-footer">
                ...
                <input type="submit" value="Asignar" class="btn btn-warning"  id="edi3"/>
                <button type="button" class="btn btn-default" data-dismiss="modal">Salir</button>
            </div>
            </form>
