...
<tr><td width="150"><?php	echo '<img src="'.$f['fotoca1'].'" width="400" heigth="400"/>';?></td></tr>
<?php } ?>
</table>

<form action="ci_subirFotoavisoCam.php" method="post" id="formulario" enctype="multipart/form-data">
