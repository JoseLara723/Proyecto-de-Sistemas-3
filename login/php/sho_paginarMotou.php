...
include('conexion.php');
    ...
    $nroProductos = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM personalmoto AS pm LEFT JOIN personal AS pe ON pm.id_per=pe.id_per WHERE pm.codsuc='$codsucx' "));
    $nroLotes = 10;
    ...
    if($paginaActual < $nroPaginas){
  	...
  	$registro = mysqli_query($conexion,"SELECT * FROM personalmoto AS pm LEFT JOIN personal AS pe ON pm.id_per=pe.id_per WHERE pm.codsuc='$codsucx'  LIMIT $limit, $nroLotes ");
