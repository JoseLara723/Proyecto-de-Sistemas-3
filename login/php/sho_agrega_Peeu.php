...
switch($proceso){
	case 'Registro':
		mysqli_query($conexion,"INSERT INTO personal (nombreper,direccper, celper, emailper, ciper,observper,codsuc,asignado)VALUES
		('$despv','$dire','$cel','$emma','$cii','$observv','$csucx','NO')");
	break;
...
//ACTUALIZAMOS LOS REGISTROS Y LOS OBTENEMOS
	$registro = mysqli_query($conexion,"SELECT * FROM personal WHERE codsuc='$codsucx' ");
...
//	$tcr=$tcr+$registro2['saldocr'];
		...
		echo '<tr>
		<td><a href="javascript:editarPee('.$registro2['id_per'].');" >'.$registro2['nombreper'].'</a></td>
							...
							<td align="center"> <a href="javascript:eliminarPee('.$registro2['id_per'].');" ><img src="../recursos/borrar.png" data-toggle="tooltip" title="Eliminar Registro"></a> <a href="javascript:mostrarfotocarga('.$registro2['id_per'].');" ><img src="../recursos/subir.png" data-toggle="tooltip" title="Subir Imagen"></a>
							   </td>
						  </tr>';
	}
