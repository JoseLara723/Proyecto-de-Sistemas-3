...
function agregaRegistroDat2(){ // sisadal
	var url = '../php/ci_agrega_Dat2.php';
	$.ajax({
		type:'POST',
		url:url,
...
function editarDat2(id){ /// sisadal
//var pregunta = confirm('¿Esta seguro de eliminar este !!!!!!');
	$('#formulario')[0].reset();
	var url = '../php/ci_editaDat2.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'id='+id,
...
function eliminarDat2(id){ //SISADAL
	var url = '../php/ci_eliminaDat2.php';
...
function pagination(partida){ /// sidsadal
	var url = '../php/ci_paginarCin2.php';
	$.ajax({
		type:'POST',
		url:url,
