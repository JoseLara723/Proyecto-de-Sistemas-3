...
function agregaRegistroGas(){ // sisadal
	var url = '../php/sho_agrega_Gastossu.php';
...
function eliminarGas(id){ //SISADAL
	var url = '../php/sho_elimina_Gas.php';
...
function pagination(partida){ /// sidsadal
	var url = '../php/sho_paginarGastou.php';
	$.ajax({
		type:'POST',
		url:url,
