...
function eliminarProp1(id){ //SISADAL
	var url = '../php/sho_eliminaPrepau.php';
...
function habilitareg(id){ //SISADAL  eliminar receta codre de $_SESSION[programa]
	var url = '../php/sho_habilita.php';
	//var pregunta =true; // confirm('¿Esta seguro de eliminar este Receta ?');
	//if(pregunta==true){
		$.ajax({
		type:'POST',
		url:url,
...
function pagination(partida){ /// sidsadal
	var url = '../php/sho_paginarMenuu.php';
	$.ajax({
		type:'POST',
		url:url,
