...
function agregaRegistroPee(){ // sisadal
	var url = '../php/sho_agrega_Peeu.php';
	$.ajax({
		type:'POST',
		url:url,
...
function eliminarPee(id){ //SISADAL
	var url = '../php/sho_elimina_Pee.php';
...
function pagination(partida){ /// sidsadal
	var url = '../php/sho_paginarPeru.php';
	$.ajax({
		type:'POST',
		url:url,
